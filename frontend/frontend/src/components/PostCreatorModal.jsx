...
const POST_CATEGORIES = [
  ...
  { id: "pr", label: "🏆 New PR", color: "#bf5af2" },
      ...
      >
        ...
        >
          {[
            ...
            { id: "blog", label: "📝 Article", icon: "📝" },
            { id: "pr", label: "🏆 New PR", icon: "🏆" },
            { id: "quick", label: "💬 Thought", icon: "💬" },
          ].map((f) => (
            <button
              key={f.id}
              onClick={() => {
        ...
        <div
          style={{
            ...
            border: `1px solid ${T.accent || "#0a84ff"}35`,
            display: "flex",
            alignItems: "center",
            justifyContent: "space-between",
            marginBottom: 16,
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12.5, fontWeight: 700 }}>
            <span style={{ color: T.textSub || "#94a3b8" }}>Drafting:</span>
            <span
              style={{
            ...
            >
              ...
              {postFormat === "pr" && "🏆 PR Milestone"}
              {postFormat === "quick" && "💬 Quick Update"}
            </span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12, fontWeight: 700 }}>
            <span style={{ color: T.textSub || "#94a3b8" }}>Topic:</span>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            {!imagePreview && !mediaUrl ? (
              ...
              >
                ...
                <div style={{ fontSize: 13.5, fontWeight: 700, marginTop: 6, color: T.accent }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 16, overflowX: "auto", paddingBottom: 4 }}>
          <span style={{ fontSize: 11, fontWeight: 700, color: T.textSub, marginRight: 2 }}>Quick:</span>
          {EMOJIS.map((emo) => (
            <button
              key={emo}
              type="button"
              onClick={() => setCaption((prev) => prev + " " + emo)}
              style={{
